...
(function($) {
	...
	$.fn.hideNavbarOnScroll = function(options) {
		...
		var setNavbar = function () {
			...
			// Creating a new css.css classes on the fly and appending them to the head of the page
			$('<style>').prop('type', 'text/css.css').html('\.header-up {\ top: -' + navbarHeight + 'px;\ } ' + plugin.el + ' {\ transition: top ' + plugin.settings.hideSpeed + 's ease-in-out; \ }').appendTo('head');
